...
class Price(models.Model):
    ...
    def __str__(self) -> str:
        suffix = (
            ""
            if self.interval == self.Interval.ONE_TIME
...
class Subscription(models.Model):
    ...
    customer = models.ForeignKey(BillingCustomer, on_delete=models.PROTECT, related_name="subscriptions")
    ...
    class Meta:
        ...
        models.UniqueConstraint(
            ...
            models.UniqueConstraint(
                ...
                name="billing_subscription_single_active_per_price",
            ),
        ]
        indexes = [
            models.Index(
...
class Payment(models.Model):
    ...
    def __str__(self) -> str: 
        return f"{Decimal(self.amount) / Decimal('100'):.2f} {self.currency.upper()} - {self.status}"
